...
public class LeilaoTeste {
	...
	public void umLance() {
		...
		leilao.propoe(new Lance(new Usuario("Rodrigo"), 2000));
	...
	public void variosLances() {
		Leilao leilao = new Leilao("Mais uma coisa");
		leilao.propoe(new Lance(new Usuario("Rodrigo 2"), 2000));
		leilao.propoe(new Lance(new Usuario("Rodrigo 3"), 3000));
	...
	@Test
	public void naoPodeMaisDeUmLance() {
		Leilao leilao = new Leilao("Outro item");
		Usuario rodrigo = new Usuario("Rodrigo");

		leilao.propoe(new Lance(rodrigo, 2000));
		leilao.propoe(new Lance(rodrigo, 3000));
